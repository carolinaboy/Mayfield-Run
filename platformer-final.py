...
# Images
idle = load_image('assets/images/characters/american.png')
walk1 = load_image('assets/images/characters/american.png')
walk2 = load_image('assets/images/characters/american.png')
jump = load_image('assets/images/characters/american.png')
hurt = load_image('assets/images/characters/american.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/platformPack_tile013.png'),
                ...
                "Plant": load_image('assets/images/tiles/grass.png'),
                "FlagTop": load_image('assets/images/tiles/medievalTile_166.png'),
                "FlagPole": load_image('assets/images/tiles/medievalTile_190.png') }
        
basic_enemy_images = { "walk1": load_image('assets/images/characters/beer.png') }

platform_enemy_images = { "walk1": load_image('assets/images/characters/enemy.png') } 

item_images = { "Gem": load_image('assets/images/items/football.png') }
...
class Game():
    ...
    def show_win_screen(self):
        ...
        text = font_sm.render("Press Space to Restart.", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_lose_screen(self):
        ...
        text2 = font_lg.render("Press Space to Restart.", 1, BLACK)
        rect2 = text.get_rect()
